...
describe("RandomMusicNFT", function () {
  const TOKEN_URI = "https://www.youtube.com/watch?v=e-ORhEE9VVg";
  ...
  describe("Deployment", function () {
    ...
    it("Does not allow non-owner addresses to mint an NFT", async function () {
  ...
  describe("Transfers and Approvals", function () {
    ...
    it("Recipient can transfer the NFT after receiving the token", async function () {
    ...
    it("Not allow non-token-owning addresses to transfer the NFT unless approved", async function () {
      const { randomMusicNFT, owner, account1, account2 } = await loadFixture(
        deployNFTFixture
      );
    ...
    it("Allow approved addresses to transfer the NFT", async function () {
      const { randomMusicNFT, owner, account1, account2 } = await loadFixture(
        deployNFTFixture
      );
